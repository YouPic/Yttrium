...
val lastErrorFieldName = "lastError".toByteArray()
val lastErrorFieldHash = "lastError".hashCode()

val causeFieldName = "cause".toByteArray()
val causeFieldHash = "cause".hashCode()

val fatalFieldName = "fatal".toByteArray()
val fatalFieldHash = "fatal".hashCode()
...
val serversFieldName = "servers".toByteArray()
val serversFieldHash = "servers".hashCode()
...
val categoriesFieldName = "categories".toByteArray()
val categoriesFieldHash = "categories".hashCode()
...
val profileFieldName = "profile".toByteArray()
val profileFieldHash = "profile".hashCode()
...
val metricFieldName = "metric".toByteArray()
val metricFieldHash = "metric".hashCode()
...
val valueFieldName = "value".toByteArray()
val valueFieldHash = "value".hashCode()
